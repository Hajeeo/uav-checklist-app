            ...
            <header ref={headerRef} className="bg-white shadow-sm sticky top-0 z-20 flex-shrink-0">
                <div className="container mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <button onClick={() => setIsSidebarOpen(true)} className="p-2 rounded-full hover:bg-gray-100">
                                <Menu className="w-6 h-6 text-gray-600" />
                            </button>
                            <div className="flex items-center ml-2">
                                <Plane className="w-7 h-7 md:w-8 md:h-8 text-blue-600" />
                                <h1 className="text-xl md:text-2xl font-bold text-gray-800 ml-1">UAV Flight Ops</h1>
                            </div>
                        </div>
